...
#+begin_src emacs-lisp
  (with-eval-after-load 'org
    ...
    (defun vulpea-agenda-files-update (&rest _)
      ...
      (setq org-agenda-files (vulpea-projet-files)))
...
_d_: date        ^ ^              ^ ^
  ...
  (setup (:pkg org-roam)
    ...
    (:when-loaded
      ...
      (add-to-list 'org-tags-exclude-from-inheritance "projet") ;;stop inheriteance from filetags
