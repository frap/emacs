...
#+begin_src emacs-lisp
  (setup (:straight vulpea
		    :type git
		    :host github
		    :repo "d12frosted/vulpea")
    (:global   "C-c n f"   vulpea-find
	       "C-c n F"   vulpea-find-backlink
	       "C-c n d"   vulpea-dailies-date
	       "C-c n d t" vulpea-dailies-today
	       "C-c n d n" vulpea-dailies-next
	       "C-c n d p" vulpea-dailies-prev
	       "C-c n i"   vulpea-insert
	       "C-c n t"   vulpea-tags-add
	       "C-c n T"   vulpea-tags-delete
	       "C-c n a"   vulpea-alias-add
	       "C-c n A"   vulpea-alias-delete
	       )
  ...
  (setup org-capture
    (:global  "C-c n c" org-capture
	    ;;  "C-c n c X" (org-capture :which-key "dispatch")
	      "C-c n a" vulpea-capture-article
	      "C-c n j" vulpea-capture-journal
	      "C-c n l" org-store-link
	      "C-c n m" vulpea-capture-meeting
	      "C-c n x" vulpea-capture-task
	      ))
  
  ...
  (setup org-agenda
    (:global "C-c A" org-agenda
	     "C-c a" vulpea-agenda-main
	    ;; "C-c a p" vulpea-agenda-person
	     )
    )
...
#+begin_src emacs-lisp
  ...
  (+with-message "Completion or Seelction"
...
*** Literature Notes
:PROPERTIES:
:header-args: :tangle lisp/lib-libnotes.el :noweb yes
:ID:       331ee651-40ef-4d13-801e-c46acc279188
:END:
#+begin_src emacs-lisp
...
:Properties:
:header-args: :tangle lisp/init-lisp.el :noweb yes
:ID:       1eb96e6e-dcd9-4ba8-bc8e-0a6eee8b4f21
:END:
