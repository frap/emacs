...
#+begin_src emacs-lisp
  ;;; enfer-pkg-window.el --- Windose -*- lexical-binding: t -*-
  <<disclaimer>>
  ;;; Code:
...
#+begin_src emacs-lisp
  ;;; enfer-pkg-project.el --- Projects -*- lexical-binding: t -*-
  <<disclaimer>>
  ;;; Code:
...
:END:
#+begin_src emacs-lisp
  ;;; enfer-key-bindings.el --- Keys -*- lexical-binding: t -*-
  <<disclaimer>>
  ;;; Code:
